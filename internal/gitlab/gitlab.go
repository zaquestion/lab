// Internal wrapper for the go-gitlab package
//
...
// IsssueCreate opens a new issue on a specified GitLab Project
...
// IsssueList gets a list of issues on a specified GitLab Project

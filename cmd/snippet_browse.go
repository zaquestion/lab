...
func init() {
	zsh.Wrap(snippetBrowseCmd).MarkZshCompPositionalArgumentCustom(1, "__lab_completion_remote")
	zsh.Wrap(snippetBrowseCmd).MarkZshCompPositionalArgumentCustom(2, "__lab_completion_snippet $words[2]")
